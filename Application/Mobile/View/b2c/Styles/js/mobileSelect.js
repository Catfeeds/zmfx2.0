...
window.MobileSelect = (function() {
	...
	function MobileSelect(config) {
		...
		this.jsonData = [];
		this.checkDataType();
		this.renderWheels(this.wheelsData,this.tips);
		this.displayJson = []; 
		this.cascade = false;
		this.startY;
		this.moveEndY;
	...
	MobileSelect.prototype = {
		...
		init: function(config){
			...
			_this.tips = config.tips ? config.tips : '';
		...
		renderWheels: function(wheelsData,tips){
			var _this = this;
			_this.mobileSelect = document.createElement("div");
			_this.mobileSelect.className = "mobileSelect zylayer"+tips;
